...
Se construye como un árbol de decisión, pero las reglas de decisión para este se eligen al azar. Las observaciones situadas a poca profundidad se pueden aislar fácilmente y se consideran anómalas, mientras que el resto se consideran normales.

Un bosque de aislamiento detecta valores atípicos con base en varias características.
